...
if x_t>=0 %barco
    ...
    if nroColOrigen>geometria.nroHorizContBarco
        nroColOrigen=geometria.nroHorizContBarco;
    end
...
%             write(ItemVectorBarco((vert-1)*13+horiz),geometria.contBarco(vert,horiz));
        end
    else
...
%             write(itm,geometria.contMuelle(vert,horiz));
        end
    end
    EscrituraOPC;
end
